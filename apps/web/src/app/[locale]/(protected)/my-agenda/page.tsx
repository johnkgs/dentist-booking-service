      ...
      <div className="flex max-w-full flex-none flex-col sm:max-w-none md:max-w-full">
        ...
        <div className="flex flex-auto">
          ...
          <div className="grid flex-auto grid-cols-1 grid-rows-1">
            <div className="col-start-1 col-end-2 row-start-1 grid grid-rows-[repeat(48,_minmax(3.5rem,_1fr))] divide-y divide-gray-100">
                  ...
                  <PopoverContent className="w-auto">
                    <div className="flex flex-col gap-6">
                      ...
                      <div className="flex justify-end">
                        <Button>{t("form.actions.call_patient")}</Button>
                      </div>
                    </div>
                  </PopoverContent>
                </Popover>
