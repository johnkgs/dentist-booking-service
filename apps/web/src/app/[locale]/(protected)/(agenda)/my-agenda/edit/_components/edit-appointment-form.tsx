...
import type { EditAppointmentFields } from "../../../appointments/_validations/new-appointment-validation"
import { SECOND } from "~/app/[locale]/_shared/utils/constants"
import { getStatuses } from "~/app/[locale]/_shared/utils/status"
import { getEditAppointmentSchema } from "../../../appointments/_validations/new-appointment-validation"
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <Button
            ...
            asChild
          >
            <Link href="/my-agenda">{t("form.actions.cancel")}</Link>
          </Button>
